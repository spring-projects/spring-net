...
API ( [HTML](docs/1.3.2/api/net-2.0/html/webframe.html) / [HTML Help](http://dist.springframework.org/release/NET/Spring.NET-1.3.2-API.chm) )
...
Reference ( [HTML](docs/1.3.1/reference/html/index.html)/ [PDF](docs/1.3.1/reference/pdf/spring-net-reference.pdf)/ [HTML Help](docs/1.3.1/reference/htmlhelp/spring-net-reference.chm) )
...
API - HtmlHelp format is included in distribution.

API - Online

° [HTML](docs/1.3.0/api/net-2.0/html/webframe.html) .NET 2.0 and higher
...
° [HTML](docs/1.3.0-RC1/api/net-2.0/html/index.html) .NET 2.0 and higher
...
API - Download for VS.NET integration and HTML Help format

° [VS.NET 2003 style + HTML Help](http://dist.springframework.org/release/NET/Spring.NET-1.2.0-net-1.1-api.zip) (.NET 1.1)  
            ° [VS.NET 2005 style + HTML Help](http://dist.springframework.org/release/NET/Spring.NET-1.2.0-net-2.0-api.zip) (.NET 2.0 and higher)

API - Online

° [HTML](docs/1.2.0/api/net-1.1/html/webframe.html) .NET 1.1  
            ° [HTML](docs/1.2.0/api/net-2.0/html/webframe.html) .NET 2.0 and higher
...
API (VS.NET 2003 style) [HTML Help](http://dist.springframework.org/milestone/NET/Spring.NET-1.2.0-RC1-net-1.1-api.chm)  
          API (VS.NET 2005 style) [HTML Help](http://dist.springframework.org/milestone/NET/Spring.NET-1.2.0-RC1-net-2.0-api.chm)
...
API (VS.NET 2003 style) [HTML Help](https://dist.springframework.org/milestone/NET/Spring.NET-1.2.0-M1-net-1.1-api.chm)  
          API (VS.NET 2005 style) [HTML Help](https://dist.springframework.org/milestone/NET/Spring.NET-1.2.0-M1-net-2.0-api.chm)
...
API (VS.NET 2003 style) [Web](docs/1.1.1/sdk/1.1/html/webframe.html) / [HTML Help](docs/1.1.2/sdk/1.1/htmlhelp/Spring.NET-SDK.chm)  
          API (VS.NET 2005 style) [Web](docs/1.1.1/sdk/2.0/html/webframe.html) / [HTML Help](docs/1.1.2/sdk/2.0/htmlhelp/Spring.NET-SDK.chm)

API documentation in HTML Help format and for integration  
          with VS.NET is available for [download](https://sourceforge.net/project/showfiles.php?group_id=106751&package_id=115147&release_id=597395).
...
API (VS.NET 2003 style) [Web](http://www.springframework.net/docs/1.1.1/sdk/1.1/html/webframe.html) / [HTML Help](http://www.springframework.net/docs/1.1.1/sdk/1.1/htmlhelp/Spring.NET-SDK.chm)  
          API (VS.NET 2005 style) [Web](http://www.springframework.net/docs/1.1.1/sdk/2.0/html/webframe.html) / [HTML Help](http://www.springframework.net/docs/1.1.1/sdk/2.0/htmlhelp/Spring.NET-SDK.chm)

API documentation in HTML Help format and for integration  
          with VS.NET is available for [download](https://sourceforge.net/project/showfiles.php?group_id=106751&package_id=115147&release_id=590400).
...
API (VS.NET 2003 style) [Web](docs/1.1/sdk/1.1/html/webframe.html) / [HTML Help](docs/1.1/sdk/1.1/htmlhelp/Spring.NET.chm)  
          API (VS.NET 2005 style) [Web](docs/1.1/sdk/2.0/html/webframe.html) / [HTML Help](docs/1.1/sdk/2.0/htmlhelp/Spring.NET.chm)
...
API (VS.NET 2003 style) [Web](docs/1.1-RC2/sdk/1.1/html/webframe.html) / [HTML Help](docs/1.1-RC1/sdk/1.1/htmlhelp/Spring.NET.chm)  
          API (VS.NET 2005 style) [Web](docs/1.1-RC2/sdk/2.0/html/webframe.html) / [HTML Help](docs/1.1-RC2/sdk/2.0/htmlhelp/Spring.NET.chm)
...
API (VS.NET 2003 style) [Web](docs/1.1-RC1/sdk/1.1/html/webframe.html) / [HTML Help](docs/1.1-RC1/sdk/1.1/htmlhelp/Spring.NET.chm)  
API (VS.NET 2005 style) [Web](docs/1.1-RC1/sdk/2.0/html/webframe.html) / [HTML Help](docs/1.1-RC1/sdk/2.0/htmlhelp/Spring.NET.chm)
...
API (VS.NET 2003 style) [Web](doc-1.1-M1/sdk/1.1/html/webframe.html) / [HTML Help](doc-1.1-M1/sdk/1.1/htmlhelp/Spring.NET.chm)  
API (VS.NET 2005 style) [Web](doc-1.1-M1/sdk/2.0/html/webframe.html) / [HTML Help](doc-1.1-M1/sdk/2.0/htmlhelp/Spring.NET.chm)
...
Spring.NET 1.0.2 API (VS.NET 2005 style) [Web](doc/sdk/2.0/html/webframe.html) / [HTML Help](doc/sdk/2.0/htmlhelp/Spring.NET.chm)
