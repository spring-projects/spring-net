        ...
        if (synPredMatched169)
        {
            match('.');
            {
                ...
                for (;;)
                {
                    ...
                    {
                        if (_cnt171 >= 1) { goto _loop171_breakloop; }
                        else
                        {
                            throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                            ;
                    ...
                    {
                        {
                            ...
                            for (;;)
                            {
                                ...
                                {
                                    if (_cnt176 >= 1) { goto _loop176_breakloop; }
                                    else
                                    {
                                        throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                        ;
            ...
            {
                {
                    ...
                    for (;;)
                    {
                        ...
                        {
                            if (_cnt179 >= 1) { goto _loop179_breakloop; }
                            else
                            {
                                throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                ;
                ...
                match('.');
                {
                    ...
                    for (;;)
                    {
                        ...
                        {
                            if (_cnt181 >= 1) { goto _loop181_breakloop; }
                            else
                            {
                                throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                ;
                        ...
                        {
                            {
                                ...
                                for (;;)
                                {
                                    ...
                                    {
                                        if (_cnt186 >= 1) { goto _loop186_breakloop; }
                                        else
                                        {
                                            throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                            ;
                ...
                {
                    {
                        ...
                        for (;;)
                        {
                            ...
                            {
                                if (_cnt190 >= 1) { goto _loop190_breakloop; }
                                else
                                {
                                    throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                    ;
                            ...
                            {
                                {
                                    ...
                                    for (;;)
                                    {
                                        ...
                                        {
                                            if (_cnt195 >= 1) { goto _loop195_breakloop; }
                                            else
                                            {
                                                throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                                ;
                    ...
                    {
                        {
                            ...
                            for (;;)
                            {
                                ...
                                {
                                    if (_cnt199 >= 1) { goto _loop199_breakloop; }
                                    else
                                    {
                                        throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                        ;
                    ...
                    {
                        {
                            ...
                            for (;;)
                            {
                                ...
                                {
                                    if (_cnt202 >= 1) { goto _loop202_breakloop; }
                                    else
                                    {
                                        throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                        ;
            ...
            case 'e':
                {
                    ...
                    } // ( ... )*
                    {
                        ...
                        for (;;)
                        {
                            ...
                            {
                                if (_cnt216 >= 1) { goto _loop216_breakloop; }
                                else
                                {
                                    throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                    ;
            ...
            case 'E':
                {
                    ...
                    } // ( ... )*
                    {
                        ...
                        for (;;)
                        {
                            ...
                            {
                                if (_cnt220 >= 1) { goto _loop220_breakloop; }
                                else
                                {
                                    throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                                    ;
    ...
    public void mHEXADECIMAL_INTEGER_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
    {
        ...
        match("0x");
        {
            ...
            for (;;)
            {
                ...
                {
                    if (_cnt206 >= 1) { goto _loop206_breakloop; }
                    else
                    {
                        throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());
                        ;
