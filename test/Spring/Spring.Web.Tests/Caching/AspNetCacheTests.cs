...
public class AspNetCacheTests
{
    ...
    {
        DictionaryEntry[] mockedRuntimeCacheEntries = { new DictionaryEntry(mockedCache.GenerateKey("keyA"), null), new DictionaryEntry(mockedCache.GenerateKey("keyB"), null), new DictionaryEntry(thisCache.GenerateKey("keyC"), null), new DictionaryEntry(otherCache.GenerateKey("keyD"), null) };
