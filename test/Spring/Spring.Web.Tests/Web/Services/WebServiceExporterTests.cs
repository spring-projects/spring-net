...
<objects xmlns='http://www.springframework.net'>
    ...
    public void AppliesCustomAttributeBuilderToType()
    {
        ...
        wse.TargetName = "noDecoratedService";
        wse.TypeAttributes = new CustomAttributeBuilder[] { new CustomAttributeBuilder(typeof(WebServiceAttribute).GetConstructor(Type.EmptyTypes), ObjectUtils.EmptyObjects) };
        wse.AfterPropertiesSet();
